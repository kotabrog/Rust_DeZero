...
mod tests {
    ...
    fn forward_normal() {
        ...
        let square_id = function_table.generate_function_from_function_contents(Box::new(Add::new()));
        ...
        assert_eq!(output.data(), Tensor::new_from_num_vec(vec![5.0, 7.0, 9.0], vec![3]).data());
    }
}
